...
export const filterAffairs = (affairs: AffairType[], filter: AffairPriorityType): AffairType[] => { // need to fix any
    ...
    switch (filter) {
        case 'low': {
            return filteredAffairs.filter(affair => affair.priority === 'low')
        }
        case 'middle': {
            return filteredAffairs.filter(affair =>affair.priority === 'middle')
        }
        case 'high': {
            return filteredAffairs.filter(affair => affair.priority === 'high')
        }
        default:
